			...
			<form class="form-horizontal" method="post" action="<?= $form_location ?>">
			  <fieldset>
				<div class="control-group" style="height:200px;">
					<button type="submit" name="submit" value="Yes - Delete Blog Entry" class="btn btn-danger">Yes - Delete News</button>
					<a class= "btn btn-primary" href= "news_manage.php"> Cancel </a>
				</div>
			  </fieldset>
			</form> 
		</div>
