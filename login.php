...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>ICT118 - PROJECT ZERO</title>
...
<body class="login" style="background-color: #5a8ebd;">
					...
					<form class="form-horizontal" action="<?= base_url() ?>login_proc.php" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="username" type="text" placeholder="type username" autocomplete="off" required/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="password" type="password" placeholder="type password" autocomplete="off" required/>
							</div>
							<div class="clearfix"></div>
